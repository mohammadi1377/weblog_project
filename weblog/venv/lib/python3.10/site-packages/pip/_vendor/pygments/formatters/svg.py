...
class SvgFormatter(Formatter):
    ...
    `nowrap`
        ...
        don't add.html a XML declaration and a doctype.  If true, the `fontfamily`
    ...
    `linenos`
        If ``True``, add.html line numbers (default: ``False``).
    ...
    `ystep`
        Offset to add.html to the Y coordinate for each subsequent line.  This should
