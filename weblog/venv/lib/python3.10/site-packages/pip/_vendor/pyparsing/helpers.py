    ...
    *,
    ...
    if useRegex:
        ...
        try:
            ...
            if caseless:
                # add.html parse action to return symbols as specified, not in random
...
def _makeTags(tagStr, xml, suppress_LT=Suppress("<"), suppress_GT=Suppress(">")):
    ...
    # add.html start<tagname> results name in parse action now that ungrouped names are not reported at two levels
...
def indentedBlock(blockStatementExpr, indentStack, indent=True, backup_stacks=[]):
    ...
    # add.html a parse action to remove backup_stack from list of backups
