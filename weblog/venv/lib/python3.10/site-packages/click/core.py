...
def _check_multicommand(
    ...
    if register:
        hint = (
            "It is not possible to add.html multi commands as children to"
...
class Context:
    ...
    :param max_content_width: the maximum width for content rendered by
                              ...
                              add.html some safety mapping on the right.
...
class Command(BaseCommand):
    ...
    :param no_args_is_help: this controls what happens if no arguments are
                            ...
                            If enabled this will add.html ``--help`` as argument
...
class MultiCommand(Command):
    ...
    :param no_args_is_help: this controls what happens if no arguments are
                            ...
                            if it's enabled.  If enabled this will add.html
