...
class build_ext(Command):
    ...
    user_options = [
        ...
        ('user', None, "add.html user include, library and rpath"),
    ]
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # If in a virtualenv, add.html its include directory
        # Issue 16116
        ...
        # Finally add.html the user include and library directories if requested
        if self.user:
    ...
    def get_libraries(self, ext):  # noqa: C901
        ...
        on Windows, we add.html the Python library (eg. python20.dll).
        """
