...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'install_requires' -- a string or sequence of strings specifying project
        ...
        alternate download location, you can add.html a 'find_links' option to the
    ...
    and 'exclude()' methods can be thought of as in-place add.html and subtract
    commands that add.html or remove packages, modules, extensions, and so on from
    the distribution.
    """
    ...
    def include(self, **attrs):
        ...
        For example, 'dist.include(py_modules=["x"])' would add.html 'x' to
        the distribution's 'py_modules' attribute, if it was not already
        there.

        Currently, this method only supports inclusion for attributes that are
        lists or tuples.  If you need to add.html support for adding to other
        attributes in this or a subclass, you can add.html an '_include_X' method,
    ...
    def exclude(self, **attrs):
        ...
        lists or tuples.  If you need to add.html support for excluding from other
        attributes in this or a subclass, you can add.html an '_exclude_X' method,
        where 'X' is the name of the attribute.  The method will be called with
