...
class ORMColumnDescription(TypedDict):
    name: str
    # TODO: add.html python_type and sql_type here; combining them
...
class LoaderStrategy:
    ...
    * it processes the ``QueryContext`` at statement construction time,
      ...
      For example, simple column attributes will add.html their represented
      column to the list of selected columns, a joined eager loader
      may establish join clauses to add.html to the statement.
