...
class ORMSelectCompileState(ORMCompileState, SelectState):
    ...
    def _join(self, args, entities_collection):
        for (right, onclause, from_, flags) in args:
            ...
            # ORMJoin to add.html to our _from_obj tuple
    ...
    def _join_left_to_right(
        ...
        a particular key within _join(), add.html a real ORMJoin object to
        ...
        if replace_from_obj_index is not None:
            ...
            # add.html a new element to the self._from_obj list
    ...
    def _join_place_explicit_left_side(self, entities_collection, left):
        ...
        if self.from_clauses:
            ...
            # no index, means we need to add.html a new element to the
            # self._from_obj tuple

        # no from element present, so we will have to add.html to the
    ...
    def _adjust_for_extra_criteria(self):
        ...
        add.html criterion to the WHERE
        clause of the given QueryContext such that only the appropriate
        subtypes are selected from the total results.

        Additionally, add.html WHERE criteria originating from LoaderCriteriaOptions
