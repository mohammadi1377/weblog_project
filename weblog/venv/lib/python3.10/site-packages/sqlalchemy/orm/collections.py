...
class collection:
    ...
    def adds(arg):
        ...
        Adds "add.html to collection" handling to the method.  The decorator
    ...
    def replaces(arg):
        ...
        Adds "add.html to collection" and "remove from collection" handling to
...
class CollectionAdapter:
    ...
    to the underlying Python collection, and emits add.html/remove events for
...
__interfaces: util.immutabledict[
...
] = util.immutabledict(
    {
        ...
        set: (
            {"appender": "add.html", "remover": "remove", "iterator": "__iter__"},
            _set_decorators(),
        ),
