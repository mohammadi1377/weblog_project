...
class LazyLoader(
    ...
    def _emit_lazyload(
        ...
        if state.load_options or (loadopt and loadopt._extra_criteria):
            ...
            # in the query, but an event may want to add.html them
...
class SubqueryLoader(PostLoader):
    ...
    def _generate_from_original_query(
        ...
        if q._distinct is True and q._order_by_clauses:
            # the logic to automatically add.html the order by columns to the query
    ...
    def setup_query(
        ...
        **kwargs,
        ...
        if user_defined_adapter is not False:
            ...
            # add.html the JOIN and create an adapter
            (
                clauses,
                adapter,
                add_to_collection,
...
class SelectInLoader(PostLoader, util.MemoizedSlots):
    ...
    def _load_for_path(
        ...
        if query_info.load_only_child:
            ...
            for state, overwrite in states:
                ...
                if None not in related_ident:
                    ...
                    # For FK values that have None, add.html them to a
        ...
        if not query_info.load_with_join:
            ...
            # entity, we add.html it explicitly.  If we made the Bundle against
