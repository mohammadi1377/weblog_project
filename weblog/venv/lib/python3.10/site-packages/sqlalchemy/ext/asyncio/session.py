...
class async_sessionmaker(Generic[_AS]):
    ...
    e.g.::
        ...
        async def run_some_sql(async_session: async_sessionmaker[AsyncSession]) -> None:
            async with async_session() as session:
                session.add.html(SomeObject(data="object"))
                session.add.html(SomeOtherObject(name="other object"))
    ...
    fixed configuration established up Template.  Note that :class:`.AsyncSession`
