...
class ColumnCollection(Generic[_COLKEY, _COL_co]):
    ...
    def add(
        ...
        .. note::
            ...
            object such as a :class:`_schema.Table`. To add.html a
...
class DedupeColumnCollection(ColumnCollection[str, _NAMEDCOL]):
    ...
    def add(
        ...
        if key is None:
            raise exc.ArgumentError(
                "Can't add.html unnamed column to column collection"
            )
    ...
    def replace(
        ...
        """add.html the given column to this collection, removing unaliased
        ...
        will remove the original 'col1' from the collection, and add.html
