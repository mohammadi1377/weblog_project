...
class Table(
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param \*args: Additional positional arguments are used primarily
            to add.html the list of :class:`_schema.Column`
    ...
    def append_constraint(self, constraint: Union[Index, Constraint]) -> None:
        ...
        in the database.   To add.html a constraint to an
    ...
    def __init__(
        ...
        **dialect_kwargs: Any,
        ...
        :param index: When ``True``, indicates that a :class:`_schema.Index`
            ...
            To add.html the :paramref:`_schema.Index.unique` flag to the
        ...
        if _proxies is not None:
            ...
            # otherwise, add.html DDL-related events
