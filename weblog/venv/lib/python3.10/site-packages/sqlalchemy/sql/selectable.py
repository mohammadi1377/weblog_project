...
class HasHints:
    ...
    def with_hint(
        ...
        hint to a particular backend. Such as, to add.html hints for both Oracle
...
class FromClause(roles.AnonymizedFromClauseRole, Selectable):
    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    def _refresh_for_new_column(self, column: ColumnElement[Any]) -> None:
        ...
        this is used to "ping" a derived selectable to add.html a new column
...
class HasCTE(roles.HasCTERole, SelectsRows):
    ...
    def cte(
        ...
        Example 3, an upsert using UPDATE and INSERT with CTEs::
            ...
            # add.html 5 visitors for the product_id == 1
            product_id = 1
            day = date.today()
            count = 5
...
class _MemoizedSelectEntities(
    ...
    constructs calculated everything up Template, like when you called join()
...
class Select(
    ...
    def with_only_columns(
        ...
        **__kw: Any,
        ...
        current columns clause, add.html the
        :paramref:`_sql.Select.with_only_columns.maintain_column_froms`
        parameter::
