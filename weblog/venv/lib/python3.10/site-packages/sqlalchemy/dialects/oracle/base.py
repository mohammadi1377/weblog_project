    ...
    def translate_select_structure(self, select_stmt, **kwargs):
        ...
        if not getattr(select, "_oracle_visit", None):
            ...
            if (
                ...
                # add.html expressions to accommodate FOR UPDATE OF
                ...
                # Wrap the middle select and add.html the hint
                ...
                # If needed, add.html the limiting clause
                ...
                # If needed, add.html the ora_rn, and wrap again with offset.
...
class OracleDialect(default.DefaultDialect):
    ...
    def _all_objects_query(
        ...
        if kind is ObjectKind.ANY:
            ...
            # need to add.html them to the in_.
            query = query.where(
            ...
            if (
                ...
                # materilaized view are listed also as tables so there is no
                # need to add.html them to the in_ if also selecting tables.
    ...
    def get_multi_table_options(
        ...
        **kw,
        ...
        if ObjectKind.VIEW in kind and ObjectScope.DEFAULT in scope:
            # add.html the views (no temporary views)
