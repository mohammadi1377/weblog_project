...
To add.html the ``IDENTITY`` keyword to a non-primary key column, specify
...
class MSSQLCompiler(compiler.SQLCompiler):
    ...
    def returning_clause(
        ...
        # row[column]), tell the compiler to also add.html the original unadapted
    ...
    def update_from_clause(
        ...
        well. Otherwise, it is optional. Here, we add.html it regardless.
