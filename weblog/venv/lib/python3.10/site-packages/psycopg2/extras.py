...
class RealDictRow(OrderedDict):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if cursor is not None:
            ...
            # populated, so we don't need to add.html attributes to the class
...
class LoggingConnection(_connection):
    ...
    def filter(self, msg, curs):
        ...
        log or to add.html some extra data to the output. The default implementation
        just does nothing.
        """
        return msg
...
class ReplicationCursor(_replicationCursor):
    ...
    def start_replication(
        ...
        if slot_type == REPLICATION_LOGICAL:
            ...
            if slot_name:
                command += f"SLOT {quote_ident(slot_name, self)} "
            # don't add.html "PHYSICAL", before 9.4 it was just START_REPLICATION XXX/XXX
