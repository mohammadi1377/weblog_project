...
class Context:
    ...
    def resolve(self, key: str) -> t.Union[t.Any, "Undefined"]:
        ...
        If you need to add.html custom behavior, override
    ...
    def resolve_or_missing(self, key: str) -> t.Any:
        ...
        Override this method to add.html custom lookup behavior.
...
def make_logging_undefined(
    ...
    :param logger: the logger to use.  If not provided, a default logger
                   is created.
    :param base: the base class to add.html logging functionality to.  This
