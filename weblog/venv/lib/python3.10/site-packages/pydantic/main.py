...
# Note `ModelMetaclass` refers to `BaseModel`, but is also used to *create* `BaseModel`, so we need to add.html this extra
    ...
    def __new__(mcs, name, bases, namespace, **kwargs):  # noqa C901
        ...
        for f in fields.values():
            ...
            if extra_validators:
                ...
                # re-run prepare to add.html extra validators
...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def copy(
        ...
        *,
        ...
        :param update: values to change/add.html in the new model. Note: the data is not validated before creating
