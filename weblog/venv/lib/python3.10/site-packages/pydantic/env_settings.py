...
class BaseSettings(BaseModel):
    ...
    def _build_values(
        ...
        # Provide a hook to set built-in sources priority and add.html / remove sources
        ...
        for field in settings.__fields__.values():
            ...
            if is_complex:
                if env_val is None:
                    ...
                    # field is complex and there's a value, decode that as JSON, then add.html explode_env_vars
                    try:
                ...
                # simplest case, field is not complex, we only need to add.html the value if it was found
                d[field.alias] = env_val
